                    ...
                    <template v-if="data">
                        ...
                        <v-list two-line subheader>
                            ...
                            >
                                ...
                                <v-list-tile-action>
                                    <v-btn  icon ripple @click="publishMessage(post,false)" color="warning" v-if="post.published" dark>
                                        <v-icon color="white">block</v-icon>
                                    </v-btn>
                                    <v-btn  icon ripple @click="publishMessage(post,true)" color="success" v-else dark>
...
<style scoped>
    ...
    .v-list__tile__action .v-btn { float:left !important; }
</style>
